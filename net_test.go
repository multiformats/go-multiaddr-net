...
func TestListenAddrs(t *testing.T) {
	...
	test("/ip4/127.0.0.1/udp/4326/udt", "", true)
	test("/ip4/0.0.0.0/tcp/4354", "", true)
	test("/ip4/0.0.0.0/udp/4355", "", false)
	test("/ip4/0.0.0.0/udp/4356/udt", "", true)
	test("/ip6/::1/tcp/4364", "", true)
	test("/ip6/::1/udp/4365", "", false)
	test("/ip6/::1/udp/4366/udt", "", true)
	test("/ip6/::/tcp/4374", "", true)
	test("/ip6/::/udp/4375", "", false)
	test("/ip6/::/udp/4376/udt", "", true)
